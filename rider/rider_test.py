...
time = 0
rider.simulate(time)
assessment = rider.currentAction.action == ActionEnum.NO_ACTION and \
    rider.currentAction.time == 0 and \
    rider.nextAction.action == ActionEnum.RIDING and \
    rider.nextAction.time == 1
...
time = 1
rider.simulate(time)
assessment =  rider.currentAction.action == ActionEnum.RIDING and \
    rider.currentAction.time == 1 and \
    rider.nextAction.action == ActionEnum.WAITING and \
    rider.nextAction.time == 31 and \
...
time = 31
rider.simulate(time)
assessment = rider.currentAction.action == ActionEnum.WAITING and \
    rider.currentAction.time == 31 and \
    rider.nextAction.action == ActionEnum.PICKUP_OR_DELIVER and \
    rider.nextAction.time == 32
...
time = 32
rider.simulate(time)
assessment = rider.currentAction.action == ActionEnum.PICKUP_OR_DELIVER and \
    rider.currentAction.time == 32 and \
    rider.nextAction.action == ActionEnum.NO_ACTION and \
    rider.nextAction.time == 33
...
rider.simulate(time)
assessment = rider.currentAction.action == ActionEnum.NO_ACTION and\
    rider.currentAction.time == 33 and \
    rider.nextAction == None
...
rider.simulate(time)
assessment = rider.currentAction.action == ActionEnum.RIDING and \
    rider.currentAction.time == 35 and \
    rider.nextAction.action == ActionEnum.WAITING and \
    rider.nextAction.time == 65
...
rider.simulate(time)
assessment = rider.currentAction.action == ActionEnum.WAITING and \
    rider.currentAction.time == 65 and \
    rider.nextAction.action == ActionEnum.PICKUP_OR_DELIVER and \
    rider.nextAction.time == 71
...
rider.simulate(time)
assessment = rider.currentAction.action == ActionEnum.PICKUP_OR_DELIVER and \
    rider.currentAction.time == 71 and \
    rider.nextAction.action == ActionEnum.NO_ACTION and \
    rider.nextAction.time == 72
...
rider.simulate(time)
assessment = rider.currentAction.action == ActionEnum.NO_ACTION and \
    rider.currentAction.time == 72 and \
    rider.nextAction == None
